...
public class DriverInfoManagePanel {
    ...
    public static void placeComponents(JPanel panel, Predicate<? super DriverLogin> predicate) {
        ...
        mMap.put(rMitem, (nil) -> {
            ...
            DriverInfoManagePanel.placeComponents(panel, null);
        ...
        mMap.put(eMitem, (nil) -> {
            ...
            try {
				build(panel, eP, DriverLoginDao.getInfo(), selectedRow);
			} catch (Exception e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
			}
    ...
    private static void build(JPanel mainPanel, JPanel panel, List<DriverLogin> users, int rows) {
        ...
        submitBtn.addActionListener(e -> {
            ...
            //刷新
            DriverInfoManagePanel.placeComponents(mainPanel, null);
